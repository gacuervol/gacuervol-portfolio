...
- [Panama Basin Heatflow Clustering](https://github.com/gacuervo/panama-basin-ml-heatflow): Unsupervised ML analysis of heat flow patterns using K-Means and Hierarchical Clustering (Python/Scikit-learn)  
